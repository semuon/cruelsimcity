...
// All exceptions will be caugth in the calling function, no need for try/catch.
// If value of a parameter is wrong then WrongCmdLineOption should be thrown (see below)
...
// Auxiliary classes
// ==========================================================
// Exception which should be thrown if parameter is wrong
